...
use App\Livewire\Public\ServicesPages\Consultation;
use App\Livewire\Public\ServicesPages\DonorPrograms;
use App\Livewire\Public\ServicesPages\EggFreezing;
use App\Livewire\Public\ServicesPages\EmbryoGenetic;
use App\Livewire\Public\ServicesPages\FertilityPreservation;
use App\Livewire\Public\ServicesPages\IcsiTreatment;
use App\Livewire\Public\ServicesPages\IvfTreatment;
use App\Livewire\Public\ServicesPages\MaleInfertility;
use App\Livewire\Public\ServicesPages\Sourrogacy;
...
Route::get('/service/ivf-treatment', IvfTreatment::class)->name('ivf-treatment');
Route::get('/service/donor-treatment', DonorPrograms::class)->name('donor-programs');
Route::get('/service/male-infertility', MaleInfertility::class)->name('male-infertility');
Route::get('/service/egg-freezing', EggFreezing::class)->name('egg-freezing');
Route::get('/service/embryo-genetic', EmbryoGenetic::class)->name('embryo-genetic');
Route::get('/service/icsi-treatment', IcsiTreatment::class)->name('icsi-treatment');
Route::get('/service/surrogacy', Sourrogacy::class)->name('surrogacy');
Route::get('/service/fertility-preservation', FertilityPreservation::class)->name('fertility-preservation');
