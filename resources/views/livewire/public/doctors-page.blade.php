<div>
    ...
    @section('description', 'Meet our team of experienced fertility specialists, embryologists, and reproductive endocrinologists dedicated to helping you achieve your dream of parenthood.')
    @section('keywords', 'fertility doctors, IVF specialists, reproductive endocrinologists, embryologists, infertility experts, fertility care team')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Meet our team of world-class fertility specialists who combine expertise, compassion, and cutting-edge techniques to provide you with the best possible care.
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">Each of our specialists focuses on specific areas of fertility care to provide you with expert treatment</p>
            </div>
            
            <div class="grid md:grid-cols-4 sm:grid-cols-2 gap-6 mb-12">
                @foreach($departments as $department)
                <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 hover:border-[#a53692] transition-colors text-center">
                    <div class="w-16 h-16 bg-[#f9f0f7] rounded-full flex items-center justify-center mx-auto mb-4">
                        <svg class="w-8 h-8 text-[#a53692]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="grid md:grid-cols-3 sm:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-lg overflow-hidden">
                    <div class="h-64 bg-gray-200">
                        <img src="{{ asset($doctor->image) }}" alt="Dr. {{ $doctor->name }}" class="w-full h-full object-cover" onerror="this.src='https://via.placeholder.com/400x400?text=Dr.+{{ urlencode($doctor->name) }}';this.onerror='';">
                    </div>
                    <div class="p-6">
                        <span class="inline-block px-3 py-1 text-xs font-semibold text-[#a53692] bg-[#f9f0f7] rounded-full mb-3">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 p-8 rounded-lg relative">
                    <div class="absolute top-0 right-0 -mt-4 -mr-4 w-12 h-12 bg-[#a53692] rounded-full flex items-center justify-center text-white text-3xl">
                        "
                    </div>
                    <p class="text-gray-600 mb-6 italic">
                        "Dr. Sharma's expertise and caring approach made our IVF journey so much easier. After years of trying, we're finally expecting twins! The entire team was amazing throughout the process."
                    </p>
                    <div class="flex items-center">
                        <div class="w-12 h-12 bg-gray-300 rounded-full mr-4">
                            <img src="{{ asset('images/patient1.jpg') }}" class="w-full h-full rounded-full object-cover" onerror="this.src='https://via.placeholder.com/100x100?text=Patient';this.onerror='';">
                        </div>
                        <div>
                ...
                <div class="bg-gray-50 p-8 rounded-lg relative">
                    ...
                    <p class="text-gray-600 mb-6 italic">
                        "Dr. Kumar diagnosed my condition correctly after years of misdiagnosis elsewhere. His treatment plan was effective and his staff was so supportive. We now have a beautiful baby boy!"
                    </p>
                    <div class="flex items-center">
                        <div class="w-12 h-12 bg-gray-300 rounded-full mr-4">
                            <img src="{{ asset('images/patient2.jpg') }}" class="w-full h-full rounded-full object-cover" onerror="this.src='https://via.placeholder.com/100x100?text=Patient';this.onerror='';">
                        </div>
                        <div>
                ...
                <div class="bg-gray-50 p-8 rounded-lg relative">
                    ...
                    <p class="text-gray-600 mb-6 italic">
                        "After multiple failed IVF attempts elsewhere, we came to Dr. Patel who completely changed our approach. Her embryology expertise was crucial in our success. We're forever grateful."
                    </p>
                    <div class="flex items-center">
                        <div class="w-12 h-12 bg-gray-300 rounded-full mr-4">
                            <img src="{{ asset('images/patient3.jpg') }}" class="w-full h-full rounded-full object-cover" onerror="this.src='https://via.placeholder.com/100x100?text=Patient';this.onerror='';">
                        </div>
                        <div>
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <span class="text-sm font-semibold text-[#a53692] tracking-wider uppercase">Excellence in Care</span>
            ...
            <div class="grid md:grid-cols-4 sm:grid-cols-2 gap-6">
                ...
                <div class="bg-white p-6 rounded-lg text-center">
                    <div class="w-16 h-16 bg-[#f9f0f7] rounded-full flex items-center justify-center mx-auto mb-4">
                        <svg class="w-8 h-8 text-[#a53692]" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-6-3a2 2 0 11-4 0 2 2 0 014 0zm-2 4a5 5 0 00-4.546 2.916A5.986 5.986 0 005 10a6 6 0 0012 0c0-.352-.035-.696-.1-1.028a4.96 4.96 0 00-1.535-2.587 5 5 0 00-3.365-1.385z" clip-rule="evenodd"></path>
                        </svg>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div class="mb-6 md:mb-0 md:w-2/3">
                    ...
                    <p class="text-lg text-white opacity-90">Schedule a consultation with one of our expert fertility doctors to discuss your unique situation.</p>
                </div>
                <div>
