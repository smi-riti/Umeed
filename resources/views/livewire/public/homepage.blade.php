<div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                ...
                <div class="flex justify-center items-center relative md:hidden order-1 ">
                    ...
                    <img src="{{ asset('cover.png') }}" alt="Umeed IVF Hospital" class="relative z-10 w-full max-w-md h-auto rounded-lg" />
                </div>
                ...
                <div class="py-0 order-2 md:order-1">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <button class="bg-[#a53692] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-md hover:bg-[#8c2b7b] font-medium text-base sm:text-lg transition-all transform hover:-translate-y-1 flex items-center justify-center">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                            </svg>
                            Book Consultation
                        </button>
                        <button class="border-2 border-[#a53692] text-[#a53692] px-6 sm:px-8 py-3 sm:py-4 rounded-md hover:bg-[#a53692] hover:text-white font-medium text-base sm:text-lg transition-all transform hover:-translate-y-1">
                            Learn More
                        </button>
                    </div>
                </div>
                ...
                <div class="hidden md:flex justify-center items-center relative order-2">
                    ...
                    <img src="{{ asset('cover.png') }}" alt="Umeed IVF Hospital" class="relative z-10 w-full max-w-md lg:max-w-lg h-auto rounded-lg " />
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-white relative overflow-hidden">
        ...
        <div class="absolute inset-0 overflow-hidden">
            <svg class="absolute -bottom-40 -left-40 text-[#f9f0f7] opacity-30 w-96 h-96" viewBox="0 0 200 200" fill="currentColor">
            ...
            <svg class="absolute -top-40 -right-40 text-[#f9f0f7] opacity-30 w-96 h-96" viewBox="0 0 200 200" fill="currentColor">
                <path d="M45,-78.1C58.3,-71.3,69.3,-59.1,75.9,-45C82.5,-31,84.7,-15.5,83.9,-0.4C83.2,14.6,79.6,29.2,71.7,41.2C63.8,53.2,51.7,62.5,38.7,68.9C25.7,75.3,12.8,78.8,-0.2,79.1C-13.1,79.5,-26.2,76.7,-40.4,72C-54.6,67.3,-69.8,60.6,-79.7,48.9C-89.6,37.2,-94.2,20.6,-93.8,4.3C-93.5,-12,-88.2,-24,-81.6,-36.3C-75,-48.6,-67,-61.3,-54.9,-68.5C-42.8,-75.7,-26.4,-77.5,-10.6,-74.9C5.1,-72.3,31.6,-85.3,45,-78.1Z" transform="translate(100 100)" />
            </svg>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center mb-12">
                ...
                <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 mt-2 mb-4">Making a Difference in Numbers</h2>
                <p class="text-lg text-gray-600 max-w-3xl mx-auto">Our dedication to excellence and cutting-edge fertility treatments has helped thousands of families worldwide</p>
            </div>

            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-10">
                <!-- Happy Families -->
                <div class="p-8 relative group rounded-xl bg-white border border-gray-100 hover:border-[#a53692] transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1">
                    <div class="absolute -top-4 -right-4 w-16 h-16 bg-[#f9f0f7] rounded-full opacity-50 group-hover:bg-[#a53692] group-hover:opacity-10 transition-all duration-300"></div>
                    ...
                    <div class="font-bold text-5xl text-[#a53692] mb-1">5000<span class="text-[#bc4fa1]">+</span></div>
                    <div class="text-lg font-medium text-gray-800">Happy Families</div>
                    <p class="mt-2 text-gray-600 text-sm">New lives brought into loving homes through our treatments</p>
                </div>
                ...
                <div class="p-8 relative group rounded-xl bg-white border border-gray-100 hover:border-[#a53692] transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1">
                    ...
                    <div class="font-bold text-5xl text-[#a53692] mb-1">85<span class="text-[#bc4fa1]">%</span></div>
                    <div class="text-lg font-medium text-gray-800">Success Rate</div>
                    <p class="mt-2 text-gray-600 text-sm">Industry-leading pregnancy success rates across all age groups</p>
                </div>
                ...
                <div class="p-8 relative group rounded-xl bg-white border border-gray-100 hover:border-[#a53692] transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1">
                    ...
                    <div class="font-bold text-5xl text-[#a53692] mb-1">15<span class="text-[#bc4fa1]">+</span></div>
                    <div class="text-lg font-medium text-gray-800">Years Experience</div>
                    <p class="mt-2 text-gray-600 text-sm">Decades of specialized fertility expertise and innovation</p>
                </div>
                ...
                <div class="p-8 relative group rounded-xl bg-white border border-gray-100 hover:border-[#a53692] transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1">
                    ...
                    <div class="font-bold text-5xl text-[#a53692] mb-1">10K<span class="text-[#bc4fa1]">+</span></div>
                    <div class="text-lg font-medium text-gray-800">IVF Cycles</div>
                    <p class="mt-2 text-gray-600 text-sm">Successful procedures performed with care and precision</p>
                </div>
            </div>
            
            <!-- Horizontal bar with achievement highlights -->
            <div class="mt-16 py-6 px-8 bg-[#f9f0f7] rounded-xl flex flex-wrap md:flex-nowrap justify-between items-center gap-6">
    ...
    <section class="py-24 relative bg-gradient-to-b from-white to-gray-50">
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            <svg class="absolute right-0 top-40 h-80 w-80 text-[#f9f0f7] opacity-70" viewBox="0 0 200 200" fill="currentColor">
                <path d="M45,-78.1C58.3,-71.3,69.3,-59.1,75.9,-45C82.5,-31,84.7,-15.5,83.9,-0.4C83.2,14.6,79.6,29.2,71.7,41.2C63.8,53.2,51.7,62.5,38.7,68.9C25.7,75.3,12.8,78.8,-0.2,79.1C-13.1,79.5,-26.2,76.7,-40.4,72C-54.6,67.3,-69.8,60.6,-79.7,48.9C-89.6,37.2,-94.2,20.6,-93.8,4.3C-93.5,-12,-88.2,-24,-81.6,-36.3C-75,-48.6,-67,-61.3,-54.9,-68.5C-42.8,-75.7,-26.4,-77.5,-10.6,-74.9C5.1,-72.3,31.6,-85.3,45,-78.1Z" transform="translate(100 100)" />
            </svg>
            <svg class="absolute left-0 bottom-40 h-80 w-80 text-[#f9f0f7] opacity-70" viewBox="0 0 200 200" fill="currentColor">
                <path d="M45,-78.1C58.3,-71.3,69.3,-59.1,75.9,-45C82.5,-31,84.7,-15.5,83.9,-0.4C83.2,14.6,79.6,29.2,71.7,41.2C63.8,53.2,51.7,62.5,38.7,68.9C25.7,75.3,12.8,78.8,-0.2,79.1C-13.1,79.5,-26.2,76.7,-40.4,72C-54.6,67.3,-69.8,60.6,-79.7,48.9C-89.6,37.2,-94.2,20.6,-93.8,4.3C-93.5,-12,-88.2,-24,-81.6,-36.3C-75,-48.6,-67,-61.3,-54.9,-68.5C-42.8,-75.7,-26.4,-77.5,-10.6,-74.9C5.1,-72.3,31.6,-85.3,45,-78.1Z" transform="translate(100 100)" />
            </svg>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center mb-16">
                <span class="inline-block px-4 py-1 bg-[#f9f0f7] rounded-full text-[#a53692] text-sm font-semibold tracking-wider uppercase mb-4">Expert Care</span>
            ...
            <div class="grid lg:grid-cols-3 gap-8 lg:gap-12">
                <!-- IVF Treatment -->
                <div class="group relative bg-white rounded-2xl overflow-hidden transform transition-all duration-300 hover:-translate-y-2">
                    <!-- Top color accent -->
                    ...
                    <div class="h-56 bg-[#f9f0f7] relative overflow-hidden">
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div class="w-32 h-32 rounded-full bg-white/80 flex items-center justify-center backdrop-blur-sm">
                    ...
                    <div class="p-8">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-2xl font-bold text-gray-900 group-hover:text-[#a53692] transition-colors">IVF Treatment</h3>
                            <span class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-[#f9f0f7] text-[#a53692]">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"/>
                                </svg>
                            </span>
                        </div>
                        <p class="text-gray-600 mb-6">Advanced In Vitro Fertilization with consistently high success rates, tailored to your specific needs and circumstances.</p>
                ...
                <div class="group relative bg-white rounded-2xl overflow-hidden transform transition-all duration-300 hover:-translate-y-2">
                    ...
                    <div class="p-8">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-2xl font-bold text-gray-900 group-hover:text-[#a53692] transition-colors">Male Infertility</h3>
                            <span class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-[#f9f0f7] text-[#a53692]">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"/>
                                </svg>
                        ...
                        <p class="text-gray-600 mb-6">Comprehensive diagnosis and treatment addressing all aspects of male fertility challenges with specialized expertise.</p>
                ...
                <div class="group relative bg-white rounded-2xl overflow-hidden transform transition-all duration-300 hover:-translate-y-2">
                    ...
                    <div class="p-8">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-2xl font-bold text-gray-900 group-hover:text-[#a53692] transition-colors">Egg Freezing</h3>
                            <span class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-[#f9f0f7] text-[#a53692]">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"/>
                                </svg>
                        ...
                        <p class="text-gray-600 mb-6">Preserve your fertility options for the future with state-of-the-art cryopreservation technology and expert care.</p>
            ...
            <div class="mt-16 grid md:grid-cols-2 gap-8">
                <div class="bg-white p-8 rounded-xl border border-gray-100 hover:border-[#a53692] transition-all duration-300 flex items-center gap-6 group">
                    <div class="flex-shrink-0 w-16 h-16 bg-[#f9f0f7] rounded-full flex items-center justify-center">
                        <svg class="w-8 h-8 text-[#a53692]" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M7 2a1 1 0 00-.707 1.707L7 4.414v3.758a1 1 0 01-.293.707l-4 4C.817 14.769 2.156 18 4.828 18h10.343c2.673 0 4.012-3.231 2.122-5.121l-4-4A1 1 0 0113 8.172V4.414l.707-.707A1 1 0 0013 2H7zm2 6.172V4h2v4.172a3 3 0 00.879 2.12l1.027 1.028a4 4 0 00-2.171.102l-.47.156a4 4 0 01-2.53 0l-.563-.187a1.993 1.993 0 00-.114-.035l1.063-1.063A3 3 0 009 8.172z" clip-rule="evenodd"/>
                        </svg>
                    </div>
                    <div>
                        <h4 class="text-xl font-bold text-gray-900 mb-2 group-hover:text-[#a53692] transition-colors">Embryo Genetic Testing</h4>
                        <p class="text-gray-600 mb-3">Comprehensive genetic screening for healthier pregnancies</p>
                        <a href="#" class="text-[#a53692] font-medium hover:text-[#8c2b7b] inline-flex items-center">
                            Learn more
                ...
                <div class="bg-white p-8 rounded-xl border border-gray-100 hover:border-[#a53692] transition-all duration-300 flex items-center gap-6 group">
                    ...
                    <div>
                        <h4 class="text-xl font-bold text-gray-900 mb-2 group-hover:text-[#a53692] transition-colors">Donor Programs</h4>
                        <p class="text-gray-600 mb-3">Egg, sperm, and embryo donor solutions with rigorous screening</p>
                        <a href="#" class="text-[#a53692] font-medium hover:text-[#8c2b7b] inline-flex items-center">
                            Learn more
                            <svg class="w-4 h-4 ml-1" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"/>
            ...
            <div class="mt-16 text-center">
                <a href="#" class="inline-flex items-center bg-white px-8 py-4 border-2 border-[#a53692] text-[#a53692] rounded-full font-medium hover:bg-[#a53692] hover:text-white transition-all duration-300 transform hover:-translate-y-1">
    ...
    <section class="py-20 bg-[#f9f0f7]/30 relative overflow-hidden">
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            <svg class="absolute -right-24 -bottom-24 h-64 w-64 text-[#f9f0f7] opacity-70" viewBox="0 0 200 200" fill="currentColor">
                <path d="M45,-78.1C58.3,-71.3,69.3,-59.1,75.9,-45C82.5,-31,84.7,-15.5,83.9,-0.4C83.2,14.6,79.6,29.2,71.7,41.2C63.8,53.2,51.7,62.5,38.7,68.9C25.7,75.3,12.8,78.8,-0.2,79.1C-13.1,79.5,-26.2,76.7,-40.4,72C-54.6,67.3,-69.8,60.6,-79.7,48.9C-89.6,37.2,-94.2,20.6,-93.8,4.3C-93.5,-12,-88.2,-24,-81.6,-36.3C-75,-48.6,-67,-61.3,-54.9,-68.5C-42.8,-75.7,-26.4,-77.5,-10.6,-74.9C5.1,-72.3,31.6,-85.3,45,-78.1Z" transform="translate(100 100)" />
            </svg>
            <svg class="absolute -left-24 -top-24 h-64 w-64 text-[#f9f0f7] opacity-70" viewBox="0 0 200 200" fill="currentColor">
                <path d="M45,-78.1C58.3,-71.3,69.3,-59.1,75.9,-45C82.5,-31,84.7,-15.5,83.9,-0.4C83.2,14.6,79.6,29.2,71.7,41.2C63.8,53.2,51.7,62.5,38.7,68.9C25.7,75.3,12.8,78.8,-0.2,79.1C-13.1,79.5,-26.2,76.7,-40.4,72C-54.6,67.3,-69.8,60.6,-79.7,48.9C-89.6,37.2,-94.2,20.6,-93.8,4.3C-93.5,-12,-88.2,-24,-81.6,-36.3C-75,-48.6,-67,-61.3,-54.9,-68.5C-42.8,-75.7,-26.4,-77.5,-10.6,-74.9C5.1,-72.3,31.6,-85.3,45,-78.1Z" transform="translate(100 100)" />
            </svg>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center mb-16">
                <span class="inline-block px-4 py-1 bg-[#f9f0f7] rounded-full text-[#a53692] text-sm font-semibold tracking-wider uppercase mb-4">Expert Team</span>
                <h2 class="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">Meet Our Specialists</h2>
                <div class="w-24 h-1.5 bg-[#a53692] mx-auto rounded-full mb-6"></div>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">World-class fertility experts dedicated to providing you with personalized care</p>
            </div>
            
            <div class="grid md:grid-cols-3 gap-8">
                @if($doctors->count() > 0)
                    @foreach($doctors as $doctor)
                    <div class="group bg-white border border-gray-100 hover:border-[#a53692] rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        <div class="p-6">
                            ...
                            <h3 class="text-xl font-bold text-gray-900 mb-2 group-hover:text-[#a53692] transition-colors">{{ $doctor->name }}</h3>
                            ...
                            <div class="flex flex-wrap gap-2 mb-4">
                                ...
                                <span class="bg-[#f9f0f7] text-[#a53692] px-3 py-1 rounded-full text-xs">ICSI</span>
                                <span class="bg-[#f9f0f7] text-[#a53692] px-3 py-1 rounded-full text-xs">Egg Freezing</span>
                            </div>
                            
                            <div class="flex gap-2">
                                <button class="flex-1 bg-[#a53692] text-white py-2 px-4 rounded-md hover:bg-[#8c2b7b] text-sm font-medium transition-colors">
                                    Book Now
                                </button>
                                <button class="px-4 py-2 border border-gray-300 text-gray-700 rounded-md hover:bg-[#f9f0f7] hover:border-[#a53692] hover:text-[#a53692] text-sm transition-colors">
                                    View Profile
                                </button>
                            </div>
                        </div>
                ...
                @else
                    ...
                    <div class="group bg-white border border-gray-100 hover:border-[#a53692] rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        <div class="p-6">
                            ...
                            <h3 class="text-xl font-bold text-gray-900 mb-2 group-hover:text-[#a53692] transition-colors">Dr. Priya Sharma</h3>
                    ...
                    <div class="group bg-white border border-gray-100 hover:border-[#a53692] rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        <div class="p-6">
                            <div class="flex items-center justify-between mb-2">
                                <span class="text-sm text-[#a53692]/70">12+ Years Experience</span>
                                <div class="flex items-center">
                                    <span class="text-yellow-400">★</span>
                                    <span class="text-sm text-gray-600 ml-1">4.8 (280)</span>
                                </div>
                            </div>
                            <h3 class="text-xl font-bold text-gray-900 mb-2 group-hover:text-[#a53692] transition-colors">Dr. Rajesh Kumar</h3>
                            <p class="text-[#a53692] font-medium mb-2">Reproductive Endocrinologist</p>
                            <p class="text-gray-600 text-sm mb-4">Male Infertility & Andrology</p>
                            
                            <div class="flex flex-wrap gap-2 mb-4">
                                <span class="bg-[#f9f0f7] text-[#a53692] px-3 py-1 rounded-full text-xs">Male Infertility</span>
                                <span class="bg-[#f9f0f7] text-[#a53692] px-3 py-1 rounded-full text-xs">TESA/PESA</span>
                                <span class="bg-[#f9f0f7] text-[#a53692] px-3 py-1 rounded-full text-xs">Varicocele</span>
                            </div>
                    ...
                    <div class="group bg-white border border-gray-100 hover:border-[#a53692] rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        <div class="p-6">
                            <div class="flex items-center justify-between mb-2">
                                <span class="text-sm text-[#a53692]/70">18+ Years Experience</span>
                                <div class="flex items-center">
                                    <span class="text-yellow-400">★</span>
                                    <span class="text-sm text-gray-600 ml-1">4.9 (160)</span>
                                </div>
                            </div>
                            <h3 class="text-xl font-bold text-gray-900 mb-2 group-hover:text-[#a53692] transition-colors">Dr. Anjali Patel</h3>
                            <p class="text-[#a53692] font-medium mb-2">Clinical Embryologist</p>
                            <p class="text-gray-600 text-sm mb-4">Embryology & Laboratory Sciences</p>
                            
                            <div class="flex flex-wrap gap-2 mb-4">
                                <span class="bg-[#f9f0f7] text-[#a53692] px-3 py-1 rounded-full text-xs">IVF Laboratory</span>
                                <span class="bg-[#f9f0f7] text-[#a53692] px-3 py-1 rounded-full text-xs">Embryo Culture</span>
                                <span class="bg-[#f9f0f7] text-[#a53692] px-3 py-1 rounded-full text-xs">Genetic Testing</span>
                            </div>
            ...
            <div class="mt-12 text-center">
                <a href="#" class="inline-flex items-center px-6 py-3 border-2 border-[#a53692] text-[#a53692] rounded-full font-medium hover:bg-[#a53692] hover:text-white transition-all duration-300">
