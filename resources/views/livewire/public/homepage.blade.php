            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-10">
                    ...
                    <div
                        ...
                        <p class="mt-2 text-gray-600 text-sm">Industry-leading pregnancy success rates across all age groups
                        </p>
                    </div>
        ...
        <section class="py-24 relative bg-gradient-to-b from-white to-gray-50">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="text-center mb-16">
                    ...
                    <p class="text-xl text-gray-600 max-w-3xl mx-auto">Comprehensive fertility treatments tailored to your
                ...
                <div class="grid lg:grid-cols-3 gap-8 lg:gap-12">
                    ...
                    <div
                        ...
                        <div class="p-8">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-2xl font-bold text-gray-900 group-hover:text-[#a53692] transition-colors">
                                    IVF Treatment</h3>
                                <span
                            ...
                            <p class="text-gray-600 mb-6">Advanced In Vitro Fertilization with consistently high success
                    ...
                    <div
                        ...
                        <div class="p-8">
                            ...
                            <p class="text-gray-600 mb-6">Comprehensive diagnosis and treatment addressing all aspects of
                ...
                <div class="mt-16 grid md:grid-cols-2 gap-8">
                    <div
                        ...
                        <div>
                            <h4 class="text-xl font-bold text-gray-900 mb-2 group-hover:text-[#a53692] transition-colors">
                    ...
                    <div
                        ...
                        <div>
                            <h4 class="text-xl font-bold text-gray-900 mb-2 group-hover:text-[#a53692] transition-colors">
                                Donor Programs</h4>
                            <p class="text-gray-600 mb-3">Egg, sperm, and embryo donor solutions with rigorous screening
                            </p>
                            <a href="#"
                                class="text-[#a53692] font-medium hover:text-[#8c2b7b] inline-flex items-center">
                                Learn more
...
<section class="py-20 bg-[#f9f0f7] relative overflow-hidden">
    <div class="absolute inset-0 opacity-70">
        <div class="absolute right-0 top-0 w-1/2 h-full bg-white opacity-60 transform -skew-x-12 translate-x-1/4">
        </div>
    </div>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center mb-16">
            ...
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">Real experiences from families who trusted us with
            ...
            @forelse($testimonials as $index => $testimonial)
                <div
                    ...
                    <div class="flex items-center mb-6">
                        ...
                        <span class="text-gray-500 text-sm ml-1">{{ number_format($testimonial->rating, 1) }}</span>
                    </div>
        ...
        <section class="py-20 bg-[#f9f0f7]/30 relative overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="text-center mb-16">
                    ...
                    <div class="w-24 h-1.5 bg-[#a53692] mx-auto rounded-full mb-6"></div>
                    <p class="text-xl text-gray-600 max-w-3xl mx-auto">World-class fertility experts dedicated to providing
                            ...
                            <div
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        <a href="{{ route('view-doctor',$doctor->id) }}"
                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="text-center lg:text-left">
                        ...
                        <p class="text-xl text-purple-100 mb-8 leading-relaxed">
                            ...
                            assessment worth ₹15,000 completely free. Take the first confident step towards building your
                            family.
                        </p>
                        ...
                        <div class="bg-white p-8 rounded-xl shadow-2xl">
                            ...
                            <form wire:submit.prevent="save" class="space-y-6">
                                <div class="flex gap-16">
                                    ...
                                    <div class="">
                                        <label for="contact" class="block text-sm font-medium text-gray-700 mb-1">Phone
                                            Number *</label>
