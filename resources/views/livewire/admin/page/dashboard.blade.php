<div class="py-6">
    <div class="px-4 sm:px-6 lg:px-8">
        <!-- Welcome Header -->
        <div class="mb-8">
            <h1 class="md:text-2xl text-xl lg:text-2xl font-semibold text-gray-900 ">Welcome to Umeed IVF Admin Dashboard
            </h1>
        ...
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 bg-[#f9f0f7] rounded-md p-3">
                            <svg class="h-6 w-6 text-[#a53692]" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                ...
                <div class="bg-gray-50 px-5 py-3">
                    <div class="text-sm">
                        <a wire:navigate href="{{ route('admin.appointments.list') }}" class="font-medium text-[#a53692] hover:text-[#8c2b7b]">View all</a>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                ...
                <div class="bg-gray-50 px-5 py-3">
                    <div class="text-sm">
                        <a wire:navigate href="{{ route('admin.doctors.list') }}" class="font-medium text-[#a53692] hover:text-[#8c2b7b]">View all</a>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                ...
                <div class="bg-gray-50 px-5 py-3">
                    <div class="text-sm">
                        <a wire:navigate href="{{ route('admin.patients') }}" class="font-medium text-[#a53692] hover:text-[#8c2b7b]">View all</a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="flex mb-2">
                                ...
                                <div class="flex-1">
                                    <div class="h-5 bg-yellow-100 rounded-md">
                                        <div class="h-5 bg-yellow-400 rounded-md"
                                            style="width: {{ max(5, ($appointmentsByStatus['pending'] / max(1, $totalAppointments)) * 100) }}%">
                                        </div>
                                    </div>
                                </div>
                                <div class="w-12 text-right text-xs text-gray-500">
                                    {{ $appointmentsByStatus['pending'] }}</div>
                            </div>
                            <div class="flex mb-2">
                                <div class="w-24 text-xs text-gray-500">Scheduled</div>
                                <div class="flex-1">
                                    <div class="h-5 bg-blue-100 rounded-md">
                                        <div class="h-5 bg-blue-400 rounded-md"
                                            style="width: {{ max(5, ($appointmentsByStatus['scheduled'] / max(1, $totalAppointments)) * 100) }}%">
                                        </div>
                                    </div>
                                </div>
                                <div class="w-12 text-right text-xs text-gray-500">
                                    {{ $appointmentsByStatus['scheduled'] }}</div>
                            </div>
                            <div class="flex mb-2">
                                <div class="w-24 text-xs text-gray-500">Completed</div>
                                <div class="flex-1">
                                    <div class="h-5 bg-green-100 rounded-md">
                                        <div class="h-5 bg-green-400 rounded-md"
                                            style="width: {{ max(5, ($appointmentsByStatus['completed'] / max(1, $totalAppointments)) * 100) }}%">
                                        </div>
                                    </div>
                                </div>
                                <div class="w-12 text-right text-xs text-gray-500">
                                    {{ $appointmentsByStatus['completed'] }}</div>
                            </div>
                            <div class="flex mb-2">
                                <div class="w-24 text-xs text-gray-500">Cancelled</div>
                                <div class="flex-1">
                                    <div class="h-5 bg-red-100 rounded-md">
                                        <div class="h-5 bg-red-400 rounded-md"
                                            style="width: {{ max(5, ($appointmentsByStatus['cancelled'] / max(1, $totalAppointments)) * 100) }}%">
                                        </div>
                                    </div>
                                </div>
                                <div class="w-12 text-right text-xs text-gray-500">
                                    {{ $appointmentsByStatus['cancelled'] }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-end justify-between h-48 gap-3">
                        ...
                        @foreach ($days as $day)
                            <div class="flex flex-col items-center flex-1">
                                ...
                                @endphp
                                <div class="w-full bg-[#f9f0f7] rounded-t-md"
        ...
        <!-- Recent Appointments - Mobile Card Layout -->
        <div class="bg-white shadow-sm rounded-lg overflow-hidden mb-6">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            Dr.
                                            {{ $appointment->doctor && $appointment->doctor->user ? $appointment->doctor->user->name : 'Unknown' }}
                                        </div>
                                        <div class="text-sm text-gray-500">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('admin.appointments.view',  $appointment->id) }}" class="text-[#a53692] hover:text-[#8c2b7b] mr-3">View</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                    ...
                    @forelse ($recentAppointments as $appointment)
                        <div class="px-4 py-4">
                            <div class="flex justify-between items-start mb-2">
                                ...
                                @endphp
                                <span
                                    class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $statusColor }} ml-2">
                                    {{ ucfirst($appointment->status) }}
                                </span>
                            </div>
                            ...
                            <div class="flex justify-end space-x-3 pt-2 border-t border-gray-100">
                                <a href="{{ route('admin.appointments.view',  $appointment->id) }}"
                                    class="text-[#a53692] hover:text-[#8c2b7b] text-sm font-medium">View</a>
            ...
            <div class="bg-gray-50 px-4 py-3 border-t border-gray-200">
                <a wire:navigate href="{{ route('admin.appointments.list') }}" class="text-sm font-medium text-[#a53692] hover:text-[#8c2b7b]">
        ...
        <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                ...
                <ul class="divide-y divide-gray-200">
                    @forelse ($topDoctors as $doctor)
                        <li class="px-6 py-4">
                            <div class="flex items-center">
                                <div
                                    class="flex-shrink-0 h-10 w-10 rounded-full bg-[#f9f0f7] flex items-center justify-center">
                                    @if ($doctor->image_url)
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-500">
                                                {{ $doctor->department->name ?? 'No Department' }}</p>
                                        </div>
                                        <div class="flex items-center text-sm text-gray-500">
                                            <svg class="h-5 w-5 text-[#a53692] mr-1" fill="none"
                ...
                <div class="bg-gray-50 px-6 py-3 border-t border-gray-200">
                    <a wire:navigate href="{{ route('admin.doctors.list') }}" class="text-sm font-medium text-[#a53692] hover:text-[#8c2b7b]">
                        View all doctors
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                ...
                <div class="bg-gray-50 px-6 py-3 border-t border-gray-200">
                    <a wire:navigate href="{{ route('admin.patients') }}" class="text-sm font-medium text-[#a53692] hover:text-[#8c2b7b]">
                        View all patients
                    </a>
                </div>
            </div>
