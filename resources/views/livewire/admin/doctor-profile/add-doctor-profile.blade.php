                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="position" wire:model="position"
                                class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#a53692] focus:border-[#a53692] transition-all bg-gray-50 hover:bg-white"
                                placeholder="Senior Consultant, Resident Doctor, etc.">
                        </div>
                        @error('position')
                            <p class="mt-1 text-sm text-red-600 flex items-center">
                                <svg class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="university" wire:model="university"
                                class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#a53692] focus:border-[#a53692] transition-all bg-gray-50 hover:bg-white"
                                placeholder="Harvard University, Stanford University, etc.">
                        </div>
                        @error('university')
                            <p class="mt-1 text-sm text-red-600 flex items-center">
                                <svg class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="membership" wire:model="membership"
                                class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#a53692] focus:border-[#a53692] transition-all bg-gray-50 hover:bg-white"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="special_interest" wire:model="special_interest"
                                class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#a53692] focus:border-[#a53692] transition-all bg-gray-50 hover:bg-white"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="language_spoken" wire:model="language_spoken"
                                class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#a53692] focus:border-[#a53692] transition-all bg-gray-50 hover:bg-white"
                    ...
                    <div>
                        ...
                        @foreach ($socialMediaLinks as $index => $link)
                            <div class="flex items-center gap-3 mb-2">
                                <div class="w-1/3">
                                    <select wire:model="socialMediaLinks.{{ $index }}.platform"
                                        class="shadow-sm focus:ring-[#a53692] border p-1 focus:border-[#a53692] block w-full md:text-md text-sm border-gray-300 rounded-md">
                                ...
                                <div class="flex-1 relative">
                                    <input type="text" wire:model="socialMediaLinks.{{ $index }}.url"
                                        class="border px-2 py-1 focus:ring-[#a53692] focus:border-[#a53692] block w-full sm:text-sm border-gray-300 rounded-md"
