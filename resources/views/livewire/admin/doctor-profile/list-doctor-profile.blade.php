                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th wire:click="sortBy('qualification')" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100">
                                <div class="flex items-center space-x-1">
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <h3 class="text-lg font-medium text-gray-900 mb-1">No doctor profiles found</h3>
                                        <p class="text-gray-500 mb-4">Get started by creating your first doctor profile.</p>
                                        <a href="{{ route('admin.doctor-profiles.add') }}" 
