<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            <nav class="sm:hidden">
                <a wire:navigate href="{{ route('admin.patients') }}" class="flex items-center text-sm text-gray-500 hover:text-gray-700 mb-4">
                ...
                <div class="bg-white shadow-sm rounded-lg border border-gray-200">
                    <div class="p-6">
                        <div class="flex flex-col items-center text-center">
                            ...
                            <p class="text-gray-500 text-sm mt-1">Patient</p>
                ...
                <div class="bg-white shadow-sm rounded-lg border border-gray-200">
                    ...
                    <div class="p-6 space-y-4">
                        <div class="text-center">
                            <div class="text-2xl font-bold text-indigo-600">{{ $appointmentsCount }}</div>
                            <div class="text-sm text-gray-500">Total Appointments</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-green-600">{{ $upcomingAppointments->count() }}</div>
                    ...
                    <div class="border-b border-gray-200">
                        <nav class="flex -mb-px">
                            <button wire:click="setActiveTab('overview')"
                                    class="@if($activeTab === 'overview') border-indigo-500 text-indigo-600 @else border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 @endif whitespace-nowrap py-4 px-6 border-b-2 font-medium text-sm">
                                Overview
                            </button>
                            <button wire:click="setActiveTab('appointments')"
                                    class="@if($activeTab === 'appointments') border-indigo-500 text-indigo-600 @else border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 @endif whitespace-nowrap py-4 px-6 border-b-2 font-medium text-sm">
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="text-center py-8">
                                ...
                                <p class="mt-1 text-sm text-gray-500">This patient has no scheduled appointments.</p>
                            </div>
                            @endif
        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200 p-8 text-center">
            ...
            <p class="mt-1 text-sm text-gray-500">The patient you're looking for doesn't exist.</p>
            <div class="mt-6">
