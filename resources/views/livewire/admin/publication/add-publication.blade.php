        ...
        <div class="bg-white border border-gray-200 rounded-lg mb-8 p-6">
            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center">
                <div class="mb-4 lg:mb-0">
                    <h1 class="text-2xl font-bold text-gray-800">Add Publication</h1>
                    <p class="text-gray-500 mt-1">Create a new research publication or academic paper</p>
                </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200">
            <form wire:submit="save" class="p-6 space-y-6">
                ...
                <div class="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-500">Enter details about the research publication</p>
                </div>
