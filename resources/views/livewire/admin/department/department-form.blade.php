            ...
            <form wire:submit="save" class="space-y-6">
                ...
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 text-[#a53692]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                @if ($name)
                    <div class="bg-gray-50 p-3 rounded-md border border-gray-200">
                        ...
                        <div class="mt-1 text-sm font-mono text-gray-700">{{ \Illuminate\Support\Str::slug($name) }}</div>
                    </div>
                @endif
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-md p-4 text-sm text-blue-700">
        <div class="flex">
            ...
            <div>
                ...
                <p class="text-blue-600">Departments help organize doctors by specialty. Each doctor can be assigned to a department, which helps patients find specialists more easily.</p>
            </div>
        </div>
    </div>
</div>
